...
export { quotaSnapshotsDb } from '@/modules/database/repositories/quota-snapshots.db.js';
...
// queuedMessagesDb: used by the message-queue module to persist outbound messages across devices.
