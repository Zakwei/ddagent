...
import { handleBrowserViewConnection } from '@/modules/browser-view/index.js';
 ...
 * browser-view, and notification routes. Exported for server startup.
 */
export function createWebSocketServer(
  ...
  wss.on('connection', (ws, request) => {
    ...
    if (pathname === '/browser-view') {
      handleBrowserViewConnection(ws, incomingRequest);
      return;
    }
