...
# Sandboxed coding agents with a web & mobile IDE (ddagent)

[Docker Sandbox](https://docs.docker.com/ai/sandboxes/) templates that add [ddagent](https://github.com/Zakwei/ddagent) on top of Claude Code and Codex. You get a full web and mobile IDE accessible from any browser on any device.
...
```bash
ddagent sandbox ls
ddagent sandbox start my-project    # Restart and re-launch web UI
...
- [Documentation](https://github.com/Zakwei/ddagent/docs) — full configuration guide
