...
export function Pill({ isActive, onClick, children, className, ...props }: PillProps) {
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'flex shrink-0 touch-manipulation items-center gap-1.5 rounded-md px-3 py-2 text-sm font-medium outline-none transition-all duration-150 focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-1 focus-visible:ring-offset-muted [@media(hover:none)_and_(pointer:coarse)]:min-h-[44px]',
        isActive
