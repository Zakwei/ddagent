 ...
 *
 * ddagent can be served from a path prefix by a reverse proxy, for example:
 *   /ai/manifest.json
                ...
                <ProtectedRoute>
                  <Router basename={routerBasename}>
                    <Routes>
                      ...
                      <Route path="/usage" element={<AppContent />} />
                      <Route path="/source-control" element={<AppContent />} />
