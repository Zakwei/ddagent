...
export default function QuickSettingsHandle({
  ...
  return (
    <button
      ...
      className={`fixed ${placementClass} z-[9999] ${transitionClass} border bg-white dark:bg-gray-800 ${borderClass} rounded-l-md p-2 shadow-lg transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 ${cursorClass} touch-none`}
      style={{
        ...style,
        touchAction: 'none',
