    ...
    const handle = setTimeout(() => {
      ...
      es.addEventListener('result', (evt) => {
        ...
        try {
          ...
          // The SSE endpoint searches globally — drop results from other
          // projects so foreign sessions can't be opened in the wrong context.
          if (projectId && pr.projectId !== projectId) return;
