...
export default function TaskHelpModal({ isOpen, onClose, onCreatePrd }: TaskHelpModalProps) {
  ...
  return (
    ...
    <Dialog open onOpenChange={(nextOpen) => { if (!nextOpen) onClose(); }}>
      <DialogContent className="max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-lg border-gray-200 bg-white p-0 shadow-xl dark:border-gray-700 dark:bg-gray-900">
        <div className="flex items-center justify-between border-b border-gray-200 p-6 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="not-sr-only text-xl font-semibold text-gray-900 dark:text-white">{t('helpGuide.title')}</DialogTitle>
          ...
          <button
            ...
            title={t('helpGuide.closeTitle', { defaultValue: 'Close' })}
          >
            <X className="h-5 w-5" />
          </button>
        </div>
