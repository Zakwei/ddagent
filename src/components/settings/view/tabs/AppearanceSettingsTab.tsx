...
export default function AppearanceSettingsTab({
  ...
  return (
    <div className="space-y-8">
      ...
      <SettingsSection title={t('appearanceSettings.terminal.title')}>
        <SettingsCard>
          <SettingsRow
            label={t('appearanceSettings.terminal.focusFollowsPointer.label')}
            description={t('appearanceSettings.terminal.focusFollowsPointer.description')}
          >
            <SettingsToggle
              checked={preferences.focusFollowsPointer}
              onChange={(value) => setPreference('focusFollowsPointer', value)}
              ariaLabel={t('appearanceSettings.terminal.focusFollowsPointer.label')}
            />
          </SettingsRow>
        </SettingsCard>
      </SettingsSection>
