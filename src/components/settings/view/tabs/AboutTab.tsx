    ...
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2">
            <span
              ...
              style={{ fontFamily: DDAGENT_WORDMARK_FONT_FAMILY }}
            >
              ddagent
            </span>
            <a
      ...
      {!IS_PLATFORM && (
        <div className="rounded-xl border border-primary/10 bg-primary/5 p-4">
          <h4 className="text-sm font-medium text-foreground">Try ddagent Hosted</h4>
      ...
      {!IS_PLATFORM && (
        <div className="space-y-4 border-t border-border/50 pt-6">
          <h3 className="text-sm font-medium text-foreground">ddagent Pro Features</h3>
          <PremiumFeatureCard
