...
- Mobile: Settings showed a hardcoded "0.1.0 (mobile scaffold)" label — it now shows the real app version; release APKs carry the release version so Android can update in place
