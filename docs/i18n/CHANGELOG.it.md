...
- Mobile: le Impostazioni mostravano un'etichetta fissa «0.1.0 (mobile scaffold)» — ora mostrano la versione reale dell'app; gli APK di release portano la versione del release, così Android può aggiornare in place

## [0.6.1] - 2026-09-26

### Correzioni

- Mobile: il selettore del modello non era disponibile sulle nuove chat, workspace multi-pannello non raggiungibile
- Mobile: i pannelli dello split workspace ora incorporano vere viste chat
